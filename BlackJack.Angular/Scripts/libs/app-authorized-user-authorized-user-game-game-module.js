...
/***/ "./src/app/authorized-user/authorized-user/game/game-routing.module.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game-routing.module.ts ***!
  \*****************************************************************************/
...
/* harmony import */ var _game_game_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./game/game.component */ "./src/app/authorized-user/authorized-user/game/game/game.component.ts");
...
/* harmony import */ var _game_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./game-routing.module */ "./src/app/authorized-user/authorized-user/game/game-routing.module.ts");
/* harmony import */ var _game_game_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./game/game.component */ "./src/app/authorized-user/authorized-user/game/game/game.component.ts");
/* harmony import */ var _game_player_output_player_output_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./game/player-output/player-output.component */ "./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.ts");
/* harmony import */ var _game_dealer_output_dealer_output_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./game/dealer-output/dealer-output.component */ "./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GameModule = /** @class */ (function () {
    ...
    GameModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _game_routing_module__WEBPACK_IMPORTED_MODULE_2__["GameRoutingModule"],
            ...
            declarations: [
                ...
                _game_player_output_player_output_component__WEBPACK_IMPORTED_MODULE_4__["PlayerOutputComponent"],
                _game_dealer_output_dealer_output_component__WEBPACK_IMPORTED_MODULE_5__["DealerOutputComponent"]
            ]
        })
    ], GameModule);
    return GameModule;
...
/***/ "./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.css":
/*!*****************************************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.css ***!
  \*****************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.html":
/*!******************************************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.html ***!
  \******************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.ts":
/*!****************************************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.ts ***!
  \****************************************************************************************************/
...
var DealerOutputComponent = /** @class */ (function () {
    ...
    DealerOutputComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./dealer-output.component.html */ "./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.html"),
            styles: [__webpack_require__(/*! ./dealer-output.component.css */ "./src/app/authorized-user/authorized-user/game/game/dealer-output/dealer-output.component.css")]
        }),
...
/***/ "./src/app/authorized-user/authorized-user/game/game/game.component.css":
/*!******************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/game.component.css ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/authorized-user/authorized-user/game/game/game.component.html":
/*!*******************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/game.component.html ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/authorized-user/authorized-user/game/game/game.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/game.component.ts ***!
  \*****************************************************************************/
...
/* harmony import */ var app_shared_models_game_view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/shared/models/game-view */ "./src/app/shared/models/game-view.ts");
/* harmony import */ var app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/shared/models/player-view */ "./src/app/shared/models/player-view.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GameComponent = /** @class */ (function () {
    function GameComponent(_route, _router, _httpService, _errorService) {
        ...
        this.Game = new app_shared_models_game_view__WEBPACK_IMPORTED_MODULE_5__["GameView"]();
    ...
    GameComponent.prototype.AddCard = function (takeCard) {
        ...
        if (takeCard) {
            this._httpService.AddCard(this.Game.Id)
                .subscribe(function (data) {
                if (data["CanTakeCard"]) {
                    _this.Game.Human = Object(json_typescript_mapper__WEBPACK_IMPORTED_MODULE_2__["deserialize"])(app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_6__["PlayerView"], data);
                }
                if (!data["CanTakeCard"]) {
    ...
    GameComponent.prototype.StartRound = function () {
        ...
        this._httpService.StartRound(this.Game.Id, this.Game.Human.GamePlayerId, this.Bet)
            .subscribe(function (data) {
            _this.Game = Object(json_typescript_mapper__WEBPACK_IMPORTED_MODULE_2__["deserialize"])(app_shared_models_game_view__WEBPACK_IMPORTED_MODULE_5__["GameView"], data["Data"]);
            if (data["Message"] != "") {
    ...
    GameComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-game',
            template: __webpack_require__(/*! ./game.component.html */ "./src/app/authorized-user/authorized-user/game/game/game.component.html"),
            styles: [__webpack_require__(/*! ./game.component.css */ "./src/app/authorized-user/authorized-user/game/game/game.component.css")]
        }),
...
/***/ "./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.css":
/*!*****************************************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.css ***!
  \*****************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.html":
/*!******************************************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.html ***!
  \******************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.ts":
/*!****************************************************************************************************!*\
  !*** ./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.ts ***!
  \****************************************************************************************************/
...
var PlayerOutputComponent = /** @class */ (function () {
    ...
    PlayerOutputComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./player-output.component.html */ "./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.html"),
            styles: [__webpack_require__(/*! ./player-output.component.css */ "./src/app/authorized-user/authorized-user/game/game/player-output/player-output.component.css")]
        })
...
/* harmony import */ var app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! app/shared/models/player-view */ "./src/app/shared/models/player-view.ts");
...
var GameView = /** @class */ (function () {
    ...
    __decorate([
        Object(json_typescript_mapper__WEBPACK_IMPORTED_MODULE_1__["JsonProperty"])({ clazz: app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_0__["PlayerView"], name: 'Human' }),
        __metadata("design:type", app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_0__["PlayerView"])
    ], GameView.prototype, "Human", void 0);
    __decorate([
        Object(json_typescript_mapper__WEBPACK_IMPORTED_MODULE_1__["JsonProperty"])({ clazz: app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_0__["PlayerView"], name: 'Dealer' }),
        __metadata("design:type", app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_0__["PlayerView"])
    ], GameView.prototype, "Dealer", void 0);
    __decorate([
        Object(json_typescript_mapper__WEBPACK_IMPORTED_MODULE_1__["JsonProperty"])({ clazz: app_shared_models_player_view__WEBPACK_IMPORTED_MODULE_0__["PlayerView"], name: 'Bots' }),
        __metadata("design:type", Array)
